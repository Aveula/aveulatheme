...
<div class="site">
  ...
  <header id="site-header">
    ...
    <?php
       ...
       * recibo el siguiente error: Notice: Trying to get property of non-object en node_page_title()
   ...
   */
  ?>
  <aside id="site-slider">
  <?php print render($page['slider']); ?>
  </aside>

  <?php
  /**
   * Bloque para los mensajes de Drupal.
   */
  ?>
  <?php if ($messages): ?>
  <aside id="system-messages">
  <?php print $messages; ?>
  </aside>
  <?php endif; ?>
  ...
  <footer id="site-footer">
    ...
    <nav>
      <ul>
        <li><a href="#" class="back-to-top">Up</a></li>
      </ul>
    </nav>
